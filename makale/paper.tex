...
the unigram prior the same two optical models differ by $0.37$\,pp at
$p=0.063$, with the left-to-right trigram by $0.44$\,pp at
$p=0.025$, and with the whole-line decoder by \deltawa\ at
$p=0.132$ --- the same sign every time, never below the threshold.
...
and 905 only by \ours. Among configurations that
...
$-2.42$\,pp into $+0.67$\,pp (76.42 to 79.51\%, a swing of 3.09\,pp
at identical ranking).

The frequency prior supplies most of the magnitude, and its value
grows with the lexicon. On the 7\,K list it is worth $+0.63$\,pp
...
extended lexicon gains 0.3--0.6\,pp over lexicon-free decoding, the
