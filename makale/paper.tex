...
three per-seed comparisons would be declared significant at the $0.05$
level, and two of them point in opposite directions ($p=0.026$ against
the transforms, $p=1\times10^{-3}$ for them). Averaged over the three
...
accuracy by five points in either direction, and its parts are not equally
important: the lexicon is worth
2.1\,pp when it is
