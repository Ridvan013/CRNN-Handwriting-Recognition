...
class CRNNTrainer:
    ...
    def train(self, train_loader: DataLoader, val_loader: DataLoader,
        ...
        for epoch in range(epochs):
            ...
            # Early stopping on val_wa — the real target metric.
            # v3_augmented used val_loss here, but val_wa was still climbing at the
            # last epoch (89.61% ep51, all-time best) when loss-patience triggered.
            if is_best_wa:
